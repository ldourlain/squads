...
def classroom(request, classroom_id):
    ...
    context = {"students": current_classroom.student_ids.all(), "group_count": range(1, current_classroom.num_of_groups +1),
               "classroom_id": classroom_id, "name": current_classroom.name}
